    ...
    return (
        <div className="space-y-6 animate-in fade-in">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-black text-slate-800 tracking-tight">Billing Management (Admin Mode)</h1>
                    <p className="text-slate-500 mt-1">Manage bills and view financial reports</p>
                </div>
                                            ...
                                            <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                                                {bill.status !== 'PAID' && bill.status !== 'CANCELLED' && (
                                                    <button
                                                        ...
                                                        className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-bold hover:bg-indigo-700 shadow-md hover:shadow-indigo-200 transition-all flex items-center gap-2"
                                                    >
                                                        <CreditCard size={16} />
                                                        Pay
                                                    </button>
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-2 bg-red-100 text-red-600 rounded-lg text-sm font-bold hover:bg-red-200 transition-colors flex items-center gap-2"
                                                    title="Delete Bill"
                                                >
                                                    <Trash2 size={16} />
                                                    CLEANUP (BILL ONLY)
            ...
            <DeleteConfirmModal
                ...
                title="Delete Bill?"
                message="Are you sure you want to delete this bill? This will also remove associated revenue and commission records."
            />
        </div>
    );
};
